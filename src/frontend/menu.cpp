...
namespace Menu
{
                    ...
                    std::function<void()> content)
    {
        ...
        ImGui::BeginChild(label, size - ImVec2(0, 12.f), ImGuiChildFlags_None,
    ...
    void RenderPatches(ImVec2 offset)
    {
        ...
        // ── Left column ──────────────────────────────
        ImGui::BeginChild("##p_left", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
        ...
        // ── Right column ─────────────────────────────
        ImGui::BeginChild("##p_right", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
    ...
    void RenderCheats(ImVec2 offset)
    {
        ...
        ImGui::BeginChild("##c_left", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
        ...
        ImGui::BeginChild("##c_right", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
    ...
    void RenderMinimap(ImVec2 offset)
    {
        ...
        float col_w = (ImGui::GetContentRegionAvail().x - 20.f) * 0.5f;
        ImGui::BeginChild("##mm_left", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
    ...
    void RenderSettings(ImVec2 offset)
    {
        ...
        float col_w = (ImGui::GetContentRegionAvail().x - 20.f) * 0.5f;
        ImGui::BeginChild("##st_left", ImVec2(col_w, 0.f), ImGuiChildFlags_None);
